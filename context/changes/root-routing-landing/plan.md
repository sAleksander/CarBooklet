...
- [x] 1.1 Lint passes: `npm run lint` — 5502078
- [x] 1.2 Build passes: `npm run build` — 5502078

#### Manual

- [x] 1.3 Visit `/` while logged in → redirects to `/dashboard` — 5502078
- [x] 1.4 Visit `/` while logged out → landing page renders — 5502078
